...
def main():
    ...
    # rospy.loginfo(Coordinate_System.findGoalPointRobust3D([0.8270498750467093, 50.338516861343344, 146.56773481824337, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 28.240915640536393, 292.09202578177445, 112.66408394713565]
    # ))
  
#     Coordinate_System.findGoalPointRobust3D([34.79082070988993, 111.32232916829774, 147.05707223927897, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 66.3371191663557, 292.09202578177445, 112.66408394713565]
# )       
    while not rospy.is_shutdown():
        rospy.ROSInterruptException  # allow control+C to exit the program        
        Movement_Control.carControl(targetSpeed = 0,steerAngle = 0)
        # Coordinate_System.travel_to(0, [39.1,180.2])
        Coordinate_System.findGoalPointRobust3D([34.79082070988993, 111.32232916829774, 147.05707223927897, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 66.3371191663557, 292.09202578177445, 112.66408394713565]
)       
        # Coordinate_System.findGoalPointRobust3D([0.8270498750467093, 50.338516861343344, 146.56773481824337, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 28.240915640536393, 292.09202578177445, 112.66408394713565]
        # )
        # rospy.loginfo(Coordinate_System.findGoalPointRobust3D([5.480459061339496, 79.80390714721815, 109.56446275803022, 129.42980481717672, 174.7268807377328, 219.4750306494611, 232.89903815996146, 203.47446116955544, 258.87192498199823, 308.20307089704505, 368.934203019689, 246.2176514213899, 42.144995386690915, 292.0906839166472, 112.66342013302162])
        # )
        rospy.loginfo("")
        
#         rospy.loginfo(Coordinate_System.findGoalPointRobust3D([34.79082070988993, 111.32232916829774, 147.05707223927897, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 66.3371191663557, 292.09202578177445, 112.66408394713565]
# ))
        # rospy.loginfo(Coordinate_System.findGoalPointRobust3D([0.8270498750467093, 50.338516861343344, 146.56773481824337, 129.43128967164375, 174.7283889396925, 219.4765398411317, 234.96670134737636, 203.47597007654693, 258.87317147433686, 308.20429526688645, 368.9355526241454, 264.341960536446, 28.240915640536393, 292.09202578177445, 112.66408394713565])
        # )
        # Coordinate_System.travel_to(0, [39.1,180.2])
