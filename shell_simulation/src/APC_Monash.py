...
def main():
    ...
    Coordinate_System.travel_to(15, [174.5,158.0])tracked working tree files would be overwritten by checkout:
        shell_simulation/src/APC_Monash.py
        shell_simulation/src/score.py
