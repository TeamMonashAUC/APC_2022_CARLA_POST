...
def R2():
    # curve
    Coordinate_System.travel_to(27, [-199.1,-95.0])
    Coordinate_System.travel_to(27, [-195.0,-104.6]) 
    Coordinate_System.travel_to(27, [-195.0,-118.3]) 
    Coordinate_System.travel_to(27, [-193.7,-127.2]) 
    Coordinate_System.travel_to(27, [-191.8,-132.4]) 
    Coordinate_System.travel_to(27, [-183.9,-144.2]) 
    Coordinate_System.travel_to(27, [-175.5,-150.1]) 
    # Coordinate_System.travel_to(15, [-165.0,-153.9]) 

    Coordinate_System.travel_to(30, [-158.0,-151.1]) 
    Coordinate_System.travel_to(30, [-151.0,-151.0]) #P6 
    Coordinate_System.travel_to(30, [-145.6,-151.0]) # traffic light 


    Coordinate_System.travel_to(30, [-121.0,-151.1]) 
    Coordinate_System.travel_to(27, [-101.4,-154.7]) # P7
    ...
    Coordinate_System.travel_to(23, [-47.8,-117.2]) # P8 
    Coordinate_System.travel_to(23, [-47.4,-105.9]) 

def R3():
    Coordinate_System.travel_to(20, [-83.20,-87.70]) #P32
    Coordinate_System.travel_to(20, [-105.9,-87.8]) 
    
    Coordinate_System.corner(18,5,180,[-124.1,-72.3],90) #turn right
    Coordinate_System.travel_to(20, [-124.30,-42.40]) # P33
    Coordinate_System.travel_to(25, [-124.50,-17.5])
    Coordinate_System.travel_to(30, [-124.50,73.0])  
    
def R4():
    Coordinate_System.travel_to(30, [-124.4,106.3])
    Coordinate_System.travel_to(30, [-124.4,123.3]) #P35
    Coordinate_System.travel_to(30, [-123.9,136.8])
    Coordinate_System.travel_to(30, [-107.6,138.7])
    Coordinate_System.travel_to(30, [-96.6,138.6])
    Coordinate_System.travel_to(30, [-82.6,134.5])
    Coordinate_System.travel_to(30, [-80.2,133.3]) #P36
    Coordinate_System.travel_to(30, [-75.7,131.8])
    Coordinate_System.travel_to(30, [-75.0,131.4])
    Coordinate_System.travel_to(30, [-71.7,129.6])
    Coordinate_System.travel_to(30, [-66.0,125.1])
    Coordinate_System.travel_to(30, [-60.5,118.5])
    Coordinate_System.travel_to(30, [-58.4,114.9])
    Coordinate_System.travel_to(30, [-55.7,106.1])
    Coordinate_System.travel_to(27, [-55.5,104.7])
    Coordinate_System.travel_to(25, [-54.8,97.8])
    Coordinate_System.travel_to(22, [-35.6,87.8])
...
def R6():
    Coordinate_System.travel_to(17, [47.9,146.0]) 
    Coordinate_System.travel_to(17, [84.70,144.10]) #P26

    #curve
    Coordinate_System.travel_to(17, [94,142.7]) 
    Coordinate_System.travel_to(17, [103.8,141.1]) 
    Coordinate_System.travel_to(17, [114.3,138.8]) 
    Coordinate_System.travel_to(17, [124.4,134.7]) 
    Coordinate_System.travel_to(17, [132.8,129.8]) 
...
def R7():
    Coordinate_System.travel_to(23, [96.2,-14.9])
    ...
    Coordinate_System.travel_to(23, [45.90,-84.90]) #P30
    Coordinate_System.travel_to(23, [45.30,-84.90]) 

def R8(): 
    Coordinate_System.travel_to(23, [-32.8,-88.0]) #P31

def R9():
    Coordinate_System.travel_to(23, [-43.7,-73.9]) 
    Coordinate_System.travel_to(23, [-43.80,-56.80]) #P9
    Coordinate_System.travel_to(23, [-43.5,-16.9]) #P10
...
def R10():
    Coordinate_System.travel_to(23, [24.8,-19.3]) 
    Coordinate_System.travel_to(23, [24.60,-30.70]) #P39
    Coordinate_System.travel_to(23, [24.4,-72.3]) 


def R11():
    Coordinate_System.travel_to(20, [44.1,-1.9]) 
    Coordinate_System.travel_to(20, [47.80,-1.80]) #P12
    Coordinate_System.travel_to(20, [66.4,-5.2]) 
    Coordinate_System.travel_to(20, [89.00,-5.50]) #P13

def R12():
    Coordinate_System.travel_to(23, [25.70,65.40]) #P38
    Coordinate_System.travel_to(23, [27.8,15.8]) 

def R13():

    Coordinate_System.travel_to(23, [31.6,15.4]) 
    Coordinate_System.travel_to(23, [31.30,19.30]) #P15

    Coordinate_System.travel_to(23, [35.4,46.2]) 
    Coordinate_System.travel_to(23, [36.30,67.2]) #P16
    Coordinate_System.travel_to(20, [36.5,74.5]) 
...
def R14():#Final ring
    ...
    Coordinate_System.travel_to(23, [189.2,50.0])
    Coordinate_System.travel_to(25, [190.0,-4.0])
    Coordinate_System.travel_to(27, [189.5,-80.0])
    Coordinate_System.travel_to(30, [188.9,-104.7])
    Coordinate_System.travel_to(30, [187.4,-116.4])
    Coordinate_System.travel_to(30, [183.9,-129.5])
    Coordinate_System.travel_to(30, [181.5,-135.7])
    Coordinate_System.travel_to(30, [179.0,-140.0])
    Coordinate_System.travel_to(33, [175.5,-146.0])
    Coordinate_System.travel_to(35, [174.4,-148.0]) #P21
    Coordinate_System.travel_to(38, [168.5,-156.0])
    Coordinate_System.travel_to(40, [156.6,-168.0])
    Coordinate_System.travel_to(40, [143.5,-176.9])
    Coordinate_System.travel_to(40, [134.7,-180.9])
    Coordinate_System.travel_to(37, [123.1,-185.0])
    Coordinate_System.travel_to(35, [111.1,-187.4])
    Coordinate_System.travel_to(32, [104.2,-187.8])
    Coordinate_System.travel_to(30, [100.0,-187.9])
    Coordinate_System.travel_to(30, [95.6,-187.8])
    Coordinate_System.travel_to(30, [10.2,-187.9]) #P22
    Coordinate_System.travel_to(30, [-145.8,-190.9]) #P23 
    Coordinate_System.travel_to(30, [-152.0,-190.7])
    Coordinate_System.travel_to(30, [-158.5,-189.7])
    Coordinate_System.travel_to(33, [-166.2,-187.9])
    Coordinate_System.travel_to(33, [-193.3,-177.6])
    Coordinate_System.travel_to(33, [-196.6,-175.9])
    Coordinate_System.travel_to(33, [-201.3,-172.6])
    Coordinate_System.travel_to(33, [-205.4,-169.2])
    Coordinate_System.travel_to(33, [-212.5,-161.2])
    Coordinate_System.travel_to(33, [-219.7,-150.9])
    Coordinate_System.travel_to(33, [-225.2,-141.4])
    Coordinate_System.travel_to(33, [-229.0,-132.3])
    Coordinate_System.travel_to(33, [-230.7,-125.9])
    Coordinate_System.travel_to(33, [-232.4,-118.1])
    Coordinate_System.travel_to(33, [-233.5,-111.5])
    Coordinate_System.travel_to(33, [-233.8,-103.8])
    Coordinate_System.travel_to(33, [-233.6,-84.3])
    Coordinate_System.travel_to(32, [-232.6,28.1]) #P24 
    Coordinate_System.travel_to(32, [-233.9,98.7])
    Coordinate_System.travel_to(30, [-224.3,132.8])
    Coordinate_System.travel_to(28, [-210.5,151.2])
    Coordinate_System.travel_to(26, [-187.9,176.2])
    Coordinate_System.travel_to(24, [-176.2,182.5])
    Coordinate_System.travel_to(22, [-163.7,186.8])
    Coordinate_System.travel_to(20, [-125.8,186.5])
    Coordinate_System.travel_to(15, [-119.4,186.6]) #P25 

def R15(): # same coor as R13 but different speed

    Coordinate_System.travel_to(20, [31.6,15.4]) 
    Coordinate_System.travel_to(23, [31.30,19.30]) #P15

    Coordinate_System.travel_to(25, [35.4,46.2]) 
...
def main():
    ...
    R10()
    Coordinate_System.corner(20,5,-90,[14.7,-88],-180) #turn right
    R8()
    Coordinate_System.corner(20,5,-180,[-43.7,-73.9],90) #turn right
    R9()
    R11()
    Coordinate_System.corner(20,5,0,[96.2,-14.9],-90) #turn right
    R7()
    Coordinate_System.corner(20,5,-180,[31.7,-68.7],90) #turn right
    Coordinate_System.travel_to(23, [31.7,-16.2]) 
    R13()

    Coordinate_System.travel_to(20, [37.2,105.6]) 
    Coordinate_System.travel_to(20, [38,132.2]) 
    Coordinate_System.corner(17,5,90,[47.9,146.0],0) #turn right
                                                                                                                                                                                                                                                                      
    R6()

    Coordinate_System.travel_to(20, [87.6,5.1]) 
    Coordinate_System.travel_to(20, [44.7,5.2]) 
    Coordinate_System.corner(20,5,180,[31.6,15.4],90) #turn right

    R15()
    Coordinate_System.travel_to(25, [37.2,105.6]) 
    Coordinate_System.travel_to(23, [38,132.2]) 
    Coordinate_System.travel_to(20, [39.1,172.8]) 

    Coordinate_System.travel_to(20, [39.1,180.2])
    Coordinate_System.corner(20,6,90,[48.3,190.2],0)
    R14()
...
# Ze Xin set
# energy_kWh: 0.3008532439662755
# energy_kWh:  0.2756749399102973
# energy_kWh:  0.2704125896971288
# energy_kWh:  0.17290669776587647
